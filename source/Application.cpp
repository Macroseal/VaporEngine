//Brandon Nguyen VaporEngine 2017 - Application.cpp
...
namespace ve
{
	...
	Application::Application(uint32_t windowWidth, uint32_t windowHeight, std::string title)
	{
	...
	void Application::Run()
	{
		...
		modeController.RequestModePush(ModeType::Pong);
